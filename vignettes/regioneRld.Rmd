...
CrosswisePermTest is a core function of the package, using this function is possible to calculate the 
permutation test between all the combination of two RSs. The results of this is an S4 object of class gMXR
