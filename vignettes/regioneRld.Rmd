...
X<-rownames(cw_Alien_ReR@matrix$GMat)
Y<-colnames(cw_Alien_ReR@matrix$GMat)
ord<-list(X=X,Y=Y)

plotCrosswiseMatrix(cw_Alien_RaR,matrix.type = "crosswise",maxVal = 0.7,ord_mat = ord)
plotCrosswiseMatrix(cw_Alien_ReG,matrix.type = "crosswise",maxVal = 0.7,ord_mat = ord)
...
plotCrosswiseMatrix(cw_Alien_ReG,matrix.type =  "correlation",maxVal = 0.7,ord_mat = ord)
...
```{r}
plotSinglePT(cw_Alien_RaR,RS1 = "regB","regB02")

plotSinglePT(cw_Alien_RaR,RS1 = "regA","regAB")

plotSinglePT(cw_Alien_RaR,RS1 = "regA","reg_no_AB")
```
