...
**regioneReload**, an R package that is the natural evolution of `r BiocStyle::Biocpkg("regioneR")` and allows to 
...
p-value calculations. Taken together, regioneReload aims to be a novel and precious addition to NGS tools and for whole genome analysis.
