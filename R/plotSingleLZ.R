...
#' @description
#'
#' Plot the result of specific local Z-Score tests from a [multiLocalZScore][mLZS-class] object in the
#' form of line plot profiles.
#'
#' @details
#'
#' This function generates a line plot with the local Z-score profiles of
#' selected region sets from a [multiLocalZScore][mLZS-class] object. This type of plot
...
#'
#' @param mLZ an object of class [multiLocalZScore][mLZS-class].
